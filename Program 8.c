...
#include <time.h>
double f(double x){
double value,pi = 3.141592653589793;
...
double a=0.0, b=10.0,exact = 0.49936338107645674464,error,my_a,my_b,my_total,total,wtime,x;
int my_id,my_n,i,p,p_num,source,tag,target,master = 0, n = 10000000;
MPI_Status status;
MPI_Init ( &argc, &argv );
